...
{
  /// <summary>
  ///   <para>Performs testing of <see cref="MarkupRequestExecutor.Url(Uri, CancellationToken)"/> method.</para>
  /// </summary>
  [Fact]
  public void Url_Method()
  {
    AssertionExtensions.Should(() => Validator.For.Markup.Request().Url(null!)).ThrowExactlyAsync<ArgumentNullException>().Await();
